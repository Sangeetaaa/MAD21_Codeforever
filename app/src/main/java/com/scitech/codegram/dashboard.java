...
public class dashboard extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        profileShow = (CardView)getView().findViewById(R.id.dashboard_Contest);
        ...
        profileShow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UpcomingContests upcomingContests = new UpcomingContests();
                FragmentManager manager = getActivity().getSupportFragmentManager();
                manager.beginTransaction().replace(R.id.fragment, upcomingContests, upcomingContests.getTag()).commit();
            }
        });
